...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'train.json',  ###Hieunt - warninng update path 
        img_prefix=data_root,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'valid.json', ###Hieunt - warninng update path 
        img_prefix=data_root,
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test.json', ###Hieunt - warninng update path 
        img_prefix=data_root,
        pipeline=test_pipeline))
